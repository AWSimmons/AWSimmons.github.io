...
export default {
    ...
    `
        ...
        story: `
           The El Niño weather pattern has led to storms in the pacific ocean which have disrupted Deuterium shipping from deepsea extraction plants to Chile and New Angeles. Markets predict a 4% increase in per-unit electricity costs as a result of the shortage.
    `
    }],
    date: '08/07/19'
};
